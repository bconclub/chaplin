...
const shotSteps: PipelineStepDefinition[] = [
  ...
  step("motion-plate", "Animate performance to the locked voice", "seedance"),
...
export const MEDIA_OUTPUT_DEFINITIONS: Record<MediaOutputType, MediaOutputDefinition> = {
  ...
  character_punch: {
    type: "character_punch",
    label: "Character Punch",
    scope: "brief",
    description: "One actor-only five-second performance package.",
    durationSeconds: 5,
    publishable: true,
    steps: [step("shot-packages", "Produce approved shot", "chaplin"), step("creative-review", "Approve Character Punch", "human", true), step("publish", "Publish approved video", "chaplin")],
  },
  character_reel: {
    type: "character_reel",
    label: "Character Reel",
    scope: "brief",
    description: "Three actor-only shots assembled into a vertical reel.",
    durationSeconds: 15,
    publishable: true,
    steps: [step("shot-packages", "Produce three approved shots", "chaplin"), step("assembly", "Assemble reel master", "ffmpeg"), step("creative-review", "Approve Character Reel", "human", true), step("publish", "Publish approved video", "chaplin")],
  },
  ugc_ad: {
    type: "ugc_ad",
    label: "UGC ad",
    scope: "brief",
    description: "Actor-and-product UGC delivery with approved product claims.",
    durationSeconds: 15,
    publishable: true,
    steps: [step("claims-lock", "Lock approved claims", "chaplin"), step("shot-packages", "Produce approved UGC shots", "chaplin"), step("brand-review", "Approve UGC cut", "human", true), step("assembly", "Assemble UGC master", "ffmpeg"), step("publish", "Publish approved video", "chaplin")],
  },
  product_hero: {
    type: "product_hero",
    label: "Product Hero",
    scope: "brief",
    description: "Product-only macro and pack-shot film.",
    durationSeconds: 15,
    publishable: true,
    steps: [step("product-lock", "Lock product identity", "chaplin"), step("shot-packages", "Produce three product shots", "chaplin"), step("brand-review", "Approve product picture lock", "human", true), step("assembly", "Assemble product hero", "ffmpeg"), step("publish", "Publish approved video", "chaplin")],
  },
  brand_spot: {
    type: "brand_spot",
    label: "Brand Spot",
    scope: "brief",
    description: "Six-shot actor-and-product narrative spot.",
    durationSeconds: 30,
    publishable: true,
    steps: [step("claims-lock", "Lock approved claims", "chaplin"), step("shot-packages", "Produce six approved shots", "chaplin"), step("brand-review", "Approve brand spot", "human", true), step("assembly", "Assemble spot master", "ffmpeg"), step("publish", "Publish approved video", "chaplin")],
  },
  trailer: {
    type: "trailer",
